...
public class CakeView extends SurfaceView {
    ...
    //This is our cake's model, we made it private :)
    ...
    public CakeView(Context context, AttributeSet attrs) {
        ...
        //Setup our palette
        cakePaint.setColor(0xFF1755B5);  //violet-red
    ...
    public void drawCandle(Canvas canvas, float left, float bottom) {
        if(model.hasCandles) {
            ...
            //looks at the model to see if the flame should be drawn
            if (model.isLit) {
    ...
    public void drawText(Canvas canvas){
        canvas.drawText("Touch Coordinate: " + model.touchX + ", " + model.touchY, 100.0f, 1000.0f, red);
    }
